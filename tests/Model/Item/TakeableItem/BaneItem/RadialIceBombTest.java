...
class RadialIceBombTest {
    ...
    public void testUse() {
        ...
        Location npc2Location = map.getDefaultLocation().getAdjacentAt(Direction.N).getAdjacentAt(Direction.N);
        Location npc3Location = map.getDefaultLocation().getAdjacentAt(Direction.N).getAdjacentAt(Direction.N).getAdjacentAt(Direction.N);
        Location npc4Location = map.getDefaultLocation().getAdjacentAt(Direction.E).getAdjacentAt(Direction.NW).getAdjacentAt(Direction.NW);
        NPC npc1 = new NPC();
        NPC npc2 = new NPC();
        NPC npc3 = new NPC();
        NPC npc4 = new NPC();
...
//        System.out.println("x: " + x + ", y: " + y);
        ...
        System.out.println(npc1.getHealth());
        System.out.println(npc2.getHealth());
        System.out.println(npc3.getHealth());
        System.out.println(npc4.getHealth());
